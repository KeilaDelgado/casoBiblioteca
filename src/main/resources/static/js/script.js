        ...
        success: function (x) {
            ...
            for (var i = 0; i < x.length; i++) {
                $("#tablita").append(
                        ...
                        + "</td><td>" + x[i].apellido + "</td><td><a href='#' onclick='editar("
...
$("#guardar").click(function () {
    ...
    $.ajax({
        ...
        data: JSON.stringify({'nombre': nombre, 'apellido': apell}),
        cache: false,
        success: function (w) {
            bootbox.alert({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    ...
                    type: 'PUT',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({'idautor': id, 'nombre': nombre, 'apellido': apell}),
                    cache: false,
                    success: function (w) {
                        bootbox.alert({
